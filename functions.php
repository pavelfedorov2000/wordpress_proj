...
function timber_style() {
    ...
    wp_enqueue_style( 'normalize-style', get_template_directory_uri() . '/assets/vendors/normalize.css' );
    wp_enqueue_style( 'magnific-style', get_template_directory_uri() . '/assets/vendors/magnific-popup.css' );
